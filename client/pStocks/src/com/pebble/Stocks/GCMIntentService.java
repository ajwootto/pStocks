...
import static com.pebble.Stocks.CommonUtilities.displayMessage;
...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onMessage(Context context, Intent intent) {
		...
		try {
			...
			//Send a message to update! GCM is great.
			if (message.contains("update")) {
				message = "update";
				generateNotification(context, "Your stocks have changed");
			} else {
				//
			}
		} catch (Exception e) {
